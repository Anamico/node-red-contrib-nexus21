...
module.exports = function(RED) {
    ...
    RED.httpAdmin.get("/allow2/paired/:id", RED.auth.needsPermission('Allow2Pairing.read'), function(req, res) {
        ...
        console.log('checking', req.params.id, nodeId, staging, persist.pairings);
    ...
    function updatePairing(nodeId, nodeData, callback) {
        ...
        if (nodeData.paired) {
            ...
            delete persist.pairings[nodeId];
    ...
    function Pairing(config) {
        ...
        var pairing = (persist.pairings && persist.pairings[nodeId]) || { paired: false, staging: staging };
        if (!pairing) {
        ...
        node.check = function (params, callback) {
            ...
            pairing = (persist.pairings && persist.pairings[nodeId]) || { paired: false, staging: staging };
